...
- Component manifests exist in `.odk/components/`
...
4. Use commands: `odk task validate-dag`, `odk task coverage`, `odk task analyze-complexity`, `odk task ready`, `odk task plan-waves`, `odk task archive-done`
