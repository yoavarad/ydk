#!/usr/bin/env python3
"""Verification plugin: FSD layer isolation -- React Vite variant.

Layer order (high to low): app > pages > widgets > features > entities > shared
"""
...
LAYER_ORDER = ["app", "pages", "widgets", "features", "entities", "shared"]
...
def layer_index(layer: str) -> int:
    """Run the react-fsd-imports verification check."""
    try:
