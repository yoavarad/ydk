"""Naming utilities for YDK generators."""
...
def derive_table_name(entity: dict) -> str:
    ...
    YDK schema allows explicit table_name; if missing, derives by
...
def pk_type(entity: dict) -> str:
    ...
    Handles both YDK map-format fields and legacy list-format fields.
    """
    pk_type_map = {
        "int": "int",
        "integer": "int",
    ...
    if isinstance(fields, dict):
        # YDK map format: {field_name: {type: ..., primary_key: true}}
