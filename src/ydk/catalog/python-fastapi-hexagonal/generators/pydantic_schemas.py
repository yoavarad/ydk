...
Generates Pydantic BaseModel request/response schemas from YDK route components.
...
Input: YDK route components, data-model.yaml
...
def main() -> None:
    ...
    datamodel_path = os.environ.get("YDK_COMPONENTS_ENTITY", "")
    services_path = os.environ.get("YDK_COMPONENTS_CONTRACT", "")
