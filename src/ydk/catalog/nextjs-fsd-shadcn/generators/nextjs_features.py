...
Input: YDK_COMPONENTS_PAGE (derives features from page mutations/queries)
       or YDK_ARTIFACT_FRONTEND_FEATURES (explicit features file)
...
export function {component_name}({{ onSuccess }}: Props) {{
  ...
  return (
    <div>
      {{/* YDK-TODO: implement {description or name} UI */}}
    </div>
  );
}}
"""
...
export function {component_name}({{ onSuccess, defaultValues }}: Props) {{
  ...
  return (
    <form onSubmit={{handleSubmit(onSubmit)}} className="space-y-4">
      {{/* YDK-TODO: add form fields using register() */}}
      {{/* Example:
    ...
    files.append(
        {
            ...
            "content": f"""// Generated by YDK ignition
...
def main() -> None:
    ...
    path = os.environ.get("YDK_ARTIFACT_FRONTEND_FEATURES", "")
