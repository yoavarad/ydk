#!/usr/bin/env python3
"""Generator: cli-client (YDK ignition pack).
...
def generate(data: dict) -> list[dict[str, str]]:
    """Generate the HTTP client files, returning YDK file dicts."""
...
def main() -> None:
    """Entry point: load YDK components and generate client files."""
