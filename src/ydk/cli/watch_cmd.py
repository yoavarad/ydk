"""ydk watch — GitHub PR comment watcher with Claude Code session resume."""
...
def install() -> None:
    ...
    if result.returncode != 0:
        ...
        typer.echo("Polling every 30 seconds. Use 'ydk watch status' to verify.")
    ...
    try:
        ...
        for r in results:
            ...
            message = (
                ...
                "\n"
                "gh pr comment {pr_number} --body '<!-- ydk-agent-reply -->\n"
                ...
                "'\n"
                "\n"
                "IMPORTANT: Every reply MUST start with <!-- ydk-agent-reply --> on the first line. "
