...
def push(
    ...
    if not sid:
        console.print("[red]No active sessions found. Start one with: ydk visual start[/red]")
...
def record(
    ...
    output: Path = typer.Option(Path(".ydk/proofs/latest"), "--output", "-o", help="Output dir for video"),  # noqa: B008
