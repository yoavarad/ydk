...
config_path = os.environ.get("ODK_COMPONENT_CONFIG", "")
config = {}
if config_path:
...
init_answers = json.loads(os.environ.get("ODK_INIT_ANSWERS", "{}"))
...
openapi_artifact = os.environ.get("ODK_ARTIFACT_OPENAPI", "")
