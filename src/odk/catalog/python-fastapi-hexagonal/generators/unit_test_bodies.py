...
Input: test-plan.yaml (ODK_COMPONENTS_TEST_PLAN), ODK contract components
...
def _use_cases_path() -> str:
    ...
    val = os.environ.get("ODK_COMPONENTS_CONTRACT", "")
...
def _render_method_stub(service_name: str, method_name: str, entity_snake: str) -> str:
    ...
    return (
        ...
        f"        # TODO[odk:test:{service_name}.{method_name}@ODK contract components]\n"
...
def _render_scenario(
    ...
    lines = [
        ...
        f"        # Arrange: {arrange}",
        f"        # Act: {act}",
        f"        # TODO[odk:test:{service_name}.{method_name}@test-plan.yaml]",
...
def _render_error_scenario(
    ...
    lines = [
        ...
        f"        # Arrange: {arrange}",
        f"        # Act: {act}",
        f"        # TODO[odk:test:{service_name}.{method_name}_error@test-plan.yaml]",
        f"        # IMPLEMENT: {assert_str}",
        "        raise NotImplementedError",
    ]
    return "\n".join(lines) + "\n"
...
def build_service_file(
    ...
    if not test_methods_written:
        ...
        lines.append(f"        # TODO[odk:test:{service_name}@test-plan.yaml]")
