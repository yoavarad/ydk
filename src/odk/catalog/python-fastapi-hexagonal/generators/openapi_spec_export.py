...
output_dir = Path(os.environ["ODK_OUTPUT_DIR"])
output_dir.mkdir(parents=True, exist_ok=True)
project_root = os.environ["ODK_PROJECT_ROOT"]
...
if venv_python.exists():
    ...
    if result.returncode != 0:
        ...
        if (
            ...
            print(
                ...
                "This is expected during initial `odk ignite`. Run 'uv sync' then:\n"
                "  odk ignite --id openapi-spec-export",
                file=sys.stderr,
            )
    ...
    # Fallback: try importing directly (works when odk runs inside the project venv)
