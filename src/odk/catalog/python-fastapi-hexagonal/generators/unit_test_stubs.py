...
Input: ODK contract components, ODK entity components
...
def build_service_context(uc: dict, entity_names: set[str]) -> dict:
    ...
    for m in methods_raw:
        ...
        todo_lines = test_todo("service", service_name, method_name, m, artifact_ref="ODK contract components")
        methods.append(
            {
                "name": method_name,
    ...
    if not methods:
        methods.append(
            {
                "name": "execute",
                "todo_lines": test_todo("service", service_name, artifact_ref="ODK contract components"),
            }
        )
