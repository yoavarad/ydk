...
ODK ignition pack for generating a complete FastAPI backend using hexagonal architecture with Protocol-based ports, SQLAlchemy models, Pydantic schemas, and full test scaffolding.

## Architecture

Generators read ODK component manifests directly via `ODK_COMPONENTS_*` env vars.
