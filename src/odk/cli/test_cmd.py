...
from odk.core.test_generator import ComponentTestGenerator
...
def _load_component(component_id: str) -> tuple[dict, dict]:
    ...
    schemas_dir = Path.cwd() / ".odk" / "schemas"
    components_dir = Path.cwd() / ".odk" / "components"
    ...
    schema_type = schema_ref.removeprefix("odk:schema:") if schema_ref.startswith("odk:schema:") else ""
