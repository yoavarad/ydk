...
if TYPE_CHECKING:
    from odk.models.visual import FeedbackEvent
...
<head>
  ...
  <title>ODK Visual Companion</title>
</head>
<body>
  <div class="mock-content" style="padding: 2rem; text-align: center;">
    <h1>ODK Visual Companion</h1>
    <p>Push content with <code>odk visual push</code> to begin.</p>
  </div>
</body>
</html>
"""
