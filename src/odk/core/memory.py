...
logger = logging.getLogger("odk.memory")
...
class MemoryEngine:
    ...
    def __init__(
        self,
        chroma_path: str | Path = ".odk/memory/chroma",
        aws_profile: str = "",
    ...
    def _get_client(self):  # noqa: ANN202
        ...
        if self._client is None:
            try:
                ...
                msg = "Install memory support: uv pip install odk[memory]"
    ...
    def _get_bm25(self) -> BM25Index:
        ...
        if self._bm25 is None:
            from odk.core.bm25_index import BM25Index as _BM25Index
    ...
    def index_all(self, config=None) -> dict:  # noqa: ANN001
        ...
        ``config`` can be an OdkConfig object, a dict, or None (uses defaults).
        ...
        def _get(key: str, default: str) -> str:
            ...
            # OdkConfig object — try project sub-object first
